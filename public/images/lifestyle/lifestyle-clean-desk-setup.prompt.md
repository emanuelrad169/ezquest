...
Purpose:
Lifestyle context image: clean desk setup with dock, monitor, and laptop.

Canvas:
1800 x 1200 px final Shopify-ready image (3:2). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Minimal desk scene with one hero dock, one laptop, and one slim monitor only.

Environment:
Very light gray wall with a clean light wood desk.
...
Product hierarchy:
Hero object: Compact docking station on the desk, visually dominant.
Supporting objects:
- One slim monitor in the background.
- One laptop kept simple and uncluttered.
...
Monitor is allowed for this asset. No keyboard, mouse, notebook, cup, phone, plant, or extra decor.
