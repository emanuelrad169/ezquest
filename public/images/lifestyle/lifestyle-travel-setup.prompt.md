...
Asset type:
lifestyle or contextual storefront image

Category:
Chargers & Power

Purpose:
Lifestyle context image: travel-ready charger and cables in a minimal bag context.

Canvas:
1800 x 1200 px final Shopify-ready image (3:2). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Minimal travel context with one compact charger as hero and one cable near the edge of a simple light gray travel pouch.

Environment:
White or very light gray background with a clean light wood desk surface.

Style:
Premium modern consumer-tech ecommerce image. Apple Store + Xiaomi + Anker-inspired minimal realism. Soft natural lighting, subtle shadows, premium realistic materials. White or very light gray wall background. Light wood desk allowed only when useful to explain the scene. No text in image. No clutter. No unnecessary props. Not a product packshot.

Product hierarchy:
Hero object: Compact travel charger.
Supporting objects:
- One neatly looped USB-C cable.
- One simple light gray travel pouch partially visible.
...
The pouch is the only travel cue. No passport, luggage, map, tickets, sunglasses, or clutter.
