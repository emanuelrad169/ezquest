...
Purpose:
Homepage hero slide 3: compact premium charging and power readiness.
...
Environment:
White wall with a seamless very light gray surface.
...
Product hierarchy:
Hero object: Compact matte white or soft gray GaN wall charger standing upright.
Supporting objects:
- One smaller charger set farther back.
- One neatly placed USB-C cable connector near the base.
...
No wall outlet required. Keep the image calm, high-end, and not catalog-like.
