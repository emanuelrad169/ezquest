...
Purpose:
Mobile homepage hero slide 1: USB-C essentials ecosystem with top text-safe whitespace.

Canvas:
1200 x 1500 px final Shopify-ready image (4:5). Generate at 1024x1536, then crop and resize to the final target.

Composition:
Portrait-first composition for Shopify mobile. Keep text-safe whitespace in the top third of the frame. Place the product story lower in the frame, with one clear hero object and restrained supporting objects. Avoid cropping through essential ports, connectors, or product edges.
...
Premium modern consumer tech product scene, minimal Apple Store style, clean white background, soft natural lighting, large empty space on TOP for text overlay, product composition in LOWER area, no text, no clutter, realistic materials, high-end commercial photography.
