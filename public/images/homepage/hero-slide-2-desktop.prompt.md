...
Category:
Desk-ready Workspace

Purpose:
Homepage hero slide 2: a calm desk-ready setup that communicates laptop expansion and organized workspace power.
...
Environment:
Very light gray wall with a clean light wood desk surface.
...
Product hierarchy:
Hero object: Compact docking station or USB-C hub as the dominant object on the desk.
Supporting objects:
- One closed or partially visible silver laptop used only for context.
- One slim monitor in the background only as requested context, soft and uncluttered.
...
No keyboard, no mouse, no stationery, no cups. Monitor is allowed only for this desk setup. Keep the desk nearly empty and the product clearly dominant.
