...
Purpose:
Homepage hero slide 4: optional travel-ready power and connectivity without travel clutter.
...
Environment:
White or very light gray background with a clean light wood desk edge.
...
Product hierarchy:
Hero object: Compact travel charger standing upright as the dominant object.
Supporting objects:
- One neatly looped cable.
- One small adapter placed lower and smaller.
...
Suggest travel through compactness only. No luggage, passport, map, airplane, hotel room, or clutter.
