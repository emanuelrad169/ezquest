...
Purpose:
Mobile homepage hero slide 2: desk-ready setup with top text-safe whitespace.
...
No keyboard, no mouse, no stationery, no cups. Monitor is allowed only for this desk setup. Keep the product lower in frame and avoid cutting off essential ports.
