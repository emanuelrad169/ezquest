...
Purpose:
Homepage hero slide 1: a premium USB-C essentials ecosystem scene for everyday connectivity.

Canvas:
2400 x 1350 px final Shopify-ready image (16:9). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Text-safe whitespace on the left side of the frame. Product story placed on the right side with a calm, premium hierarchy. Use 2-4 total objects. Avoid catalog-style equal-weight layout. The hero product must be visually dominant, with supporting products lower, smaller, or farther back.

Environment:
White or very light gray wall with a minimal seamless surface.

Style:
Premium modern consumer-tech ecommerce image. Apple Store + Xiaomi + Anker-inspired minimal realism: airy store-like whitespace with clear accessory-category storytelling. Soft natural lighting, subtle shadows, premium realistic materials. White or very light gray wall background. Large clean whitespace for Shopify text overlays. No text in image. No clutter. No unnecessary props. Not a product packshot.

Product hierarchy:
Hero object: Slim satin aluminum USB-C hub angled to show useful connectivity.
Supporting objects:
- One compact USB-C adapter placed lower and smaller.
- One neatly curved USB-C cable connector as a quiet support object.
...
Premium modern consumer tech product scene, minimal Apple Store style, clean white background, soft natural lighting, large empty space on LEFT for text overlay, product composition on RIGHT area, no text, no clutter, realistic materials, high-end commercial photography.
