...
Asset type:
Collection index card - Cables

Purpose:
Full-bleed collection index card visual for USB-C cable quality.

Canvas:
800 x 600 px final Shopify-ready image (4:3). Generate at 1024x1024, then crop and resize to the final target.

Composition:
4:3 full-bleed card. Text-safe bottom third. One hero coiled cable with one straight connector support.

Environment:
Dark textured surface with premium studio light.

Primary request:
Coiled and straight USB-C cables on dark textured surface. Premium product arrangement, dark moody aesthetic. Text-safe bottom third.
...
Product hierarchy:
Hero object: Coiled braided USB-C cable.
Supporting objects:
- One straight cable connector detail.
