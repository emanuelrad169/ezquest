...
Asset type:
Collection index card - Hubs

Purpose:
Full-bleed collection index card visual for USB-C hubs.

Canvas:
800 x 600 px final Shopify-ready image (4:3). Generate at 1024x1024, then crop and resize to the final target.

Composition:
4:3 full-bleed card. Text-safe bottom third. One hero USB-C hub with one supporting adapter.

Environment:
Dark slate surface with restrained studio light.

Primary request:
Top-down flat lay of USB-C hubs on a dark slate surface. Premium product photography, dark moody aesthetic, silver and space gray products. Text-safe bottom third.
...
Product hierarchy:
Hero object: Silver or space gray USB-C hub.
Supporting objects:
- One smaller adapter only.
