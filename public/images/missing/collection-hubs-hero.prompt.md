...
Asset type:
Collection hero - Hubs & Adapters

Purpose:
Collection hero for hubs and docking station browsing with text-safe top-left space.

Canvas:
1920 x 600 px final Shopify-ready image (16:5). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide 3.2:1 banner. Text-safe top-left area. Product story centered-right with one hero USB-C hub and one supporting dock or adapter.

Environment:
Minimal white desk with a MacBook Pro nearby, soft studio lighting, light gray background.

Primary request:
Premium USB-C hubs and docking stations arranged on a minimal white desk with a MacBook Pro nearby. Soft studio lighting, light grey background, products as hero subjects. No text, no people.
...
Product hierarchy:
Hero object: Premium satin aluminum USB-C hub or compact docking station arranged as the dominant subject.
Supporting objects:
- One MacBook Pro nearby for context.
- One smaller supporting adapter or cable connector.
