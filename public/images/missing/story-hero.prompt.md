...
Purpose:
Our Story page hero with premium design studio feeling.

Canvas:
1440 x 680 px final Shopify-ready image (36:17). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide shot with text-safe left side, products arranged neatly on the right and center.

Environment:
Wide tech product design studio with clean white tables and natural daylight.

Primary request:
Wide shot of a tech product design studio. Clean white tables, USB-C accessories arranged in a grid on a light surface. Premium minimal aesthetic, natural daylight. No text, no people.
...
Product hierarchy:
Hero object: Clean grid of USB-C accessories on a light surface.
Supporting objects:
- Subtle design studio surfaces only.
