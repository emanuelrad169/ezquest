...
Purpose:
Downloads page hero with technical clarity and left-side headline space.

Canvas:
1440 x 480 px final Shopify-ready image (3:1). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide hero with headline-safe left third. USB-C hub and subtle icon overlays on the right.

Environment:
Clean light background with subtle device-icon style overlays.

Primary request:
USB-C hub with device icons appearing as subtle overlays. Clean light background, minimal tech illustration style. Space for headline text on left.
...
Supporting objects:
- Subtle abstract device indicators, no text.
