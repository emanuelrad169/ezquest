...
Purpose:
Default article image for resources posts without a featured image.

Canvas:
1440 x 600 px final Shopify-ready image (12:5). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide editorial crop with one USB-C hub and cable as hero, leaving calm whitespace.

Environment:
Minimal white desk with warm studio lighting and shallow depth of field.

Primary request:
USB-C cable and hub on a minimal white desk. Clean product photography style, shallow depth of field, warm studio lighting. Suitable as article featured image. No text.
