...
Purpose:
Story timeline visual for product thinking and accessory evolution.

Canvas:
1440 x 680 px final Shopify-ready image (36:17). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Overhead flat lay with a clean text-safe background and one dominant accessory family grouping.

Environment:
White paper background with neutral studio lighting.

Primary request:
Overhead flat lay of USB-C accessories on white paper background. Various EZQuest products arranged neatly, premium product photography. Neutral, text-safe background.
...
Product hierarchy:
Hero object: USB-C hub and cable grouping.
Supporting objects:
- One adapter or charger, placed smaller.
