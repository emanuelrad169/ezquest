...
Purpose:
Editorial about-page hero with premium workspace context.

Canvas:
1440 x 680 px final Shopify-ready image (36:17). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide editorial image with text-safe left side and product context on the right. One hero hub with laptop and charger support.

Environment:
Minimal white desk with warm window light and clean Californian atmosphere.

Primary request:
Modern tech workspace with a MacBook, USB-C hub, and charger on a minimal white desk. Warm ambient light from a window, premium lifestyle feel, clean Californian aesthetic. No text, no people.
...
Product hierarchy:
Hero object: USB-C hub near a MacBook.
Supporting objects:
- One charger.
- One neatly placed cable.
