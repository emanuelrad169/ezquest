...
Asset type:
Homepage feature - Warranty

Purpose:
Feature section image for trust, quality, and warranty support.

Canvas:
1200 x 800 px final Shopify-ready image (3:2). Generate at 1536x1024, then crop and resize to the final target.

Composition:
3:2 image with hub as hero and very subtle shield iconography as abstract shape, no text.

Environment:
Light gray surface with clean trustworthy lighting.

Primary request:
Two-year warranty concept: EZQuest USB-C hub on a light surface with subtle quality/shield iconography. Clean, trustworthy, premium aesthetic. Light grey background. No text.
...
Supporting objects:
- Subtle quality or shield iconography, abstract and text-free.
