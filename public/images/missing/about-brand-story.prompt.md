...
Purpose:
Brand story image for careful product connection and reliability.

Canvas:
1440 x 680 px final Shopify-ready image (36:17). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Close crop of hands and product detail, keeping the hub and cable connection as the hero.

Environment:
Light warm studio background with shallow depth of field.

Primary request:
Close-up of hands carefully connecting a USB-C cable to a premium laptop hub. Shallow depth of field, studio lighting, premium product detail photography style. Light warm background.
...
Product hierarchy:
Hero object: USB-C cable connecting to a premium laptop hub.
Supporting objects:
- Partial laptop edge only.
