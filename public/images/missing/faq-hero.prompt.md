...
Purpose:
FAQ page hero with soft product context and text-safe top half.

Canvas:
1440 x 480 px final Shopify-ready image (3:1). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide hero with text-safe top half. Accessories lower in frame with one clear hero product.

Environment:
Light gray surface with soft even studio lighting.

Primary request:
Clean minimal flat lay of EZQuest accessories on a light grey surface. Product photography, soft even studio lighting, premium aesthetic. Text-safe top half.
...
Product hierarchy:
Hero object: EZQuest-style USB-C hub or adapter.
Supporting objects:
- One cable or charger only.
