...
Asset type:
Collection index card - Accessories

Purpose:
Full-bleed collection index card visual for adapters and accessories.

Canvas:
800 x 600 px final Shopify-ready image (4:3). Generate at 1024x1024, then crop and resize to the final target.

Composition:
4:3 full-bleed card. Text-safe bottom third. One hero adapter with one supporting accessory.

Environment:
Dark slate surface with premium studio lighting.

Primary request:
USB-C adapters and small accessories on dark slate. Flat lay, premium studio photography, dark moody lighting. Text-safe bottom third.
...
Product hierarchy:
Hero object: USB-C adapter or card reader.
Supporting objects:
- One small accessory only.
