...
Purpose:
Default Open Graph sharing image for EZQuest.

Canvas:
1200 x 630 px final Shopify-ready image (40:21). Generate at 1536x1024, then crop and resize to the final target.

Composition:
1.91:1 social image. Product selection arranged with a clear hero product and ample empty space. No rendered text.

Environment:
Dark background with clean bold product composition and amber accent.

Primary request:
Selection of premium USB-C products on a dark background. Clean, bold, recognizable brand image for social sharing. Amber accent on hero product. No text, no wordmark, no fake logo marks.
...
Product hierarchy:
Hero object: Premium USB-C hub with subtle amber accent light.
Supporting objects:
- One charger.
- One cable connector.
