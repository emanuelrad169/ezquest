...
Purpose:
Collection image for Chargers & Power that reads compact and powerful.
...
Environment:
White wall with seamless very light gray surface.
...
Product hierarchy:
Hero object: Compact GaN wall charger standing upright.
Supporting objects:
- One smaller charger behind it.
- One USB-C cable connector near the base.
