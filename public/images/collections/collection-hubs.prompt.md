...
Purpose:
Collection image for Hubs & Adapters with category clarity and premium materials.
...
Product hierarchy:
Hero object: Slim aluminum USB-C multimedia hub angled to reveal ports.
Supporting objects:
- One compact USB-C adapter.
- One small cable connector as scale context.
