...
Purpose:
Promote chargers and power products inside the docking stations collection grid.

Canvas:
1200 x 628 px final Shopify-ready image (300:157). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide promotional tile. Compact charger is the hero object with two connected devices as supporting context. Leave calm overlay-safe negative space.

Environment:
Minimal light desk, soft white background, warm studio-natural lighting.

Primary request:
GaN wall charger charging a MacBook Pro, iPad, and iPhone simultaneously. Clean minimal desk, white background, warm studio lighting. Multiple devices powered from one compact charger. No text. Premium product photography.
...
Product hierarchy:
Hero object: Compact GaN wall charger powering multiple devices.
Supporting objects:
- Laptop or tablet edge
- One phone and one clean USB-C cable
