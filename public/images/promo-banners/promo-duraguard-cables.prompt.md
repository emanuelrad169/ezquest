...
Purpose:
Promote cables and accessories inside the chargers and power collection grid.

Canvas:
1200 x 628 px final Shopify-ready image (300:157). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide promotional tile. One braided USB-C cable connector is the hero, with one supporting coil. Keep the image simple and overlay-safe.

Environment:
Clean dark graphite or light gray surface with controlled premium studio lighting.

Primary request:
DuraGuard braided USB-C cables arranged artfully on a refined graphite surface. Coiled and straight cable details, Kevlar weave texture visible in macro detail. Premium product photography, subtle moody aesthetic, silver connectors. No text.
...
Product hierarchy:
Hero object: DuraGuard braided USB-C cable connector with visible weave texture.
Supporting objects:
- A single quiet cable coil
