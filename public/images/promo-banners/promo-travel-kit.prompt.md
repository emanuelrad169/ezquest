...
Purpose:
Promote hubs and adapters inside the accessories collection grid.

Canvas:
1200 x 628 px final Shopify-ready image (300:157). Generate at 1536x1024, then crop and resize to the final target.

Composition:
Wide promotional tile. Compact travel hub is the hero object with a charger and one cable as supporting objects. Keep edges calm for overlay copy.

Environment:
Minimal travel pouch context on a clean light hotel desk or pale wood surface.

Primary request:
Compact USB-C travel hub, GaN charger, and coiled cable arranged in an open minimalist travel pouch on a hotel desk. Clean lifestyle photography, warm neutral tones, professional traveler aesthetic. No text.
...
Product hierarchy:
Hero object: Compact USB-C travel hub.
Supporting objects:
- One compact charger
- One neatly coiled USB-C cable
