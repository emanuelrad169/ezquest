...
Purpose:
Homepage category card for Docking Stations, simple icon-like premium composition.
...
Product hierarchy:
Hero object: Compact aluminum docking station.
Supporting objects:
- One neat USB-C cable connector.
