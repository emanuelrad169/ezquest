...
Purpose:
Homepage category card for Hubs & Adapters, simple icon-like premium composition.
...
Product hierarchy:
Hero object: Slim aluminum USB-C hub.
Supporting objects:
- One tiny adapter placed lower and smaller.
