...
Purpose:
Homepage category card for Cables & Accessories, simple icon-like premium composition.

Canvas:
1200 x 1200 px final Shopify-ready image (1:1). Generate at 1024x1024, then crop and resize to the final target.

Composition:
Bold, simple focal point for a compact storefront tile. Use 1-2 objects. Keep the product large enough to read quickly, with clean whitespace for overlay copy. Avoid equal-weight bundles and avoid visual clutter.

Environment:
White or very light gray seamless background.
...
Product hierarchy:
Hero object: Premium braided USB-C cable with clean connector detail.
Supporting objects:
